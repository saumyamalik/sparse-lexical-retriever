...
def main(args):
    ...
    # changed this line
    tokenizer, query_encoder, doc_encoder = beir_helper.load_retriever(args.model_name_or_path, args.step_path, args.is_BM25)
    # model = model.cuda()
    # model.eval()
    # query_encoder = model
    # doc_encoder = model
    ...
    # go to beir_utils, comment out the DenseRetriever model stuff, replace with our own model (can pass it here)
    # our own model needs an encode_queries and encode_corpus function
...
if __name__ == "__main__":
    ...
    parser.add_argument("--step_path", type=str, help="step of latest version of this model")
    parser.add_argument(
    ...
    parser.add_argument("--is_BM25", type=int, default=0, help="whether the model being evaluated is BM25")
